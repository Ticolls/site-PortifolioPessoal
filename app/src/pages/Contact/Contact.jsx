    ...
    return (
        <section className='contact-section'>
            ...
            <div className="contact-content">
                ...
                <div className='links'>
                    <a className="link" href='https://github.com/Ticolls' target="_blank"><GitHubIcon /> <p>Github</p></a>
                    <a className="link"><MessageIcon />  <p>WhatsApp</p></a>
                    <a className="link linkedin" href='https://www.linkedin.com/in/thiago-seixas-4b5781251/' target="_blank"><LinkedinIcon /> <p>Linkedin</p> </a>
